...
def final(query: str):
    ...
    #query = "Find me a sleep doctor for my mom" #add hallucinted location
    #query = "Find a knee pain doctor for my 5 year old" #adds halucinated location and no results
    ...
    bisonquery = llm_bison_getquery(PROJECT_ID, DATASET_ID, TABLE_ID, schemastring, providerlist, location, language)
